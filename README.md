...
│       ├── simbolo-metodo-azul.png / simbolo-metodo-branco.png
│       ├── sistemas/          6 imagens dos sistemas de armazenagem
│       └── cases/             3 fotos dos cases
└── design-system/
    └── index.html             Design system da marca (não indexado no Google)
```
...
5. Em 1–2 minutos o site estará em `https://SEU-USUARIO.github.io/metodo-landing/`.
   O design system fica em `.../metodo-landing/design-system/`.
